                ...
                function(b, c) { (function() {
                    ...
                    d = "undefined" != typeof Emitter && null !== Emitter ? Emitter: a("component~emitter@1.1.2"),
                        ...
                        b = function(a) {
                            ...
                            var c;
                            return l(b, a),
                                b.prototype.events = ["drop","initimage", "dragstart", "dragend", "dragenter", "dragover", "dragleave", "addedfile", "removedfile", "thumbnail", "error", "errormultiple", "processing", "processingmultiple", "uploadprogress", "totaluploadprogress", "sending", "sendingmultiple", "success", "successmultiple", "canceled", "canceledmultiple", "complete", "completemultiple", "reset", "maxfilesexceeded", "maxfilesreached"],
                                b.prototype.defaultOptions = {
                                    ...
                                    initimage: function(info) {
                                        ...
                                        for( var i in info_array )
                                        {
                                            ...
                                            var fileext = hidefileval_arr[hidefileval_arr.length-1].toLocaleLowerCase();
                                            var mockfile_object = { name: hidefileval_arr[hidefileval_arr.length-1], accepted:true }
                                            this.emit('addedfile', mockfile_object);
                                            if(fileext.lastIndexOf('.jpg')>0 || fileext.lastIndexOf('.jpeg')>0 || fileext.lastIndexOf('.png')>0 || fileext.lastIndexOf('.gif')>0) {
