    ...
    $.fn.extend({
        takungaeImgup : function(opt, serverCallBack) {
            ...
            $(this).change(function() {
                ...
                if (fileList.length > opt.imageNum|| totalNum > opt.imageNum) {
                    ...
                    for ( var i = 0; i < fileList.length; i++) {
                        ...
                        var path = '/resource/assets/css/img/';
                        if(type === 'jpg' || type === 'png' || type === 'gif' || type === 'bmp' || type === 'jpeg'){
                            $img.attr("src", imgArr[i]);
                        }else if (type === 'xlsx' || type === 'xls'){
                            $img.attr("src", path + 'excel.png');
                        }
                        else if (type === 'doc' || type === 'docx'){
                            $img.attr("src", path + 'word.png');
                        }
                        else if(type === 'pdf'){
                            $img.attr("src", path + 'pdf.png');
                        }else{
                            $img.attr("src", path + 'files.png');
                        }
            ...
            $(".wsdel-ok").click(function(event) {
                ...
                if (opt.delete) {
                    opt.delete(); delete opt.delete;
                }
            });

            console.log($(".wsdel-ok"));
