...
?>
<table style="width: 100%;font-size: 12px;line-height: 18px;" cellpadding="0" cellspacing="0">
    <tbody>
    <tr style="height:20px" class="firstRow" >
        ...
        <td colspan="3" style="width: 42%">
            合同编号：<span style=""><?php echo $project->BusinessID?></span>
        </td>
    </tr>
    <tr style="height:20px">
        <td colspan="3" >
            日&nbsp;&nbsp;&nbsp; 期：<span style=""><?php echo date('Y-m-d',strtotime('-30 day '.$exportdate))?></span>
        </td>
    </tr>
    <tr style="height:20px">
        <td colspan="3">
    ...
    <tr style="height:20px">
        ...
        <td colspan="4" style="width: 42%">
            卖方：<span style=""><?php echo $invoicer?$invoicer->name:''?></span>
        </td>
    </tr>
    <tr style=";height:35px">
        ...
        <td colspan="4">
            地址：<?php echo $invoicer?$invoicer->address:''?>
        </td>
    </tr>
    ...
    <tr style=";height:128px">
        <td colspan="4" >
            ...
            公司地址: <?=$company->address?><br/>
            电话: <?=$company->contact?><br/>
            税号: <?=$company->creditno?><br/>
            开户银行: <?=$company->bkname?><br/>
            账号: <?=$company->account?><br/>
        </td>
        <td colspan="4">
            银行信息:<br/>
            公司名称:<?php echo $invoicer?$invoicer->name:''?><br/>
            公司地址:<?php echo $invoicer?$invoicer->address:''?><br/>
            电话: <br/>
    ...
    <tr style=";height:38px">
        <td colspan="8" >
            &nbsp;<span style="">九、争议的解决：凡因本合同引起的或与本合同有关的争议，双方应通过友好协商解决，如果协商不能解决，应提交上海市仲裁委员会仲裁。仲裁裁决是终局的，对双方均有约束力，仲裁费由败诉方承担。</span>
        </td>
    </tr>
    <tr style="height:20px">
        <td colspan="8">
    ...
    <tr >
        ...
        <td colspan="3">
            卖&nbsp;&nbsp;方<br /><br />
            <?php echo $invoicer?$invoicer->name:''?>
        </td>
    </tr>
    </tbody>
</table>
