...
<table style="width: 100%;font-size: 12px;line-height: 18px;" cellpadding="0" cellspacing="0">
    ...
    <?php foreach($goods as $item) {?>
        ...
        <tr style="height:62px">
            ...
            <td  class="td" style="border-left: 0px solid black;border-bottom: 1px solid black;border-right: 1px solid black;border-top: 0px solid black;">
                <?=(is_numeric($row->productunit)?(Utility::Unit($row->productunit)):$row->productunit)?>
            </td>
            <td  class="td" style="border-left: 0px solid black;border-bottom: 1px solid black;border-right: 1px solid black;border-top: 0px solid black;">
    ...
    <tr >
        <td colspan="4" style="background-image:url('<?=$stamper_png?>');background-repeat:no-repeat;height: 160px;">
            买&nbsp;&nbsp; 方<br /><br />
