...
<?php
    $data = (object) $data;
    $company =(object) get_company( $data->companyid );
...
<table style="width:100%;font-size:12px;vertical-align:top;border-collapse:collapse;">
    ...
    <tr>
        <td style="border: 1px solid black;vertical-align: middle;height: 160px;" class="cell_spacing" colspan="2" rowspan="2">
            <img src="<?=$stamper_png?>" style="width: 100%">
        </td>
        <td style="border: 1px solid black; text-align: left;vertical-align: middle;height: 160px;" class="cell_spacing" colspan="4">备注:<?=$data->note?></td>
    </tr>
    <tr>
