...
?>
<p class="row" style="font-size:20px;text-align:center">交易水单</p>
...
<table style="width:100%;font-size:12px;vertical-align:top;border-collapse:collapse;">
    <tr>
        ...
        <td style="border: 1px solid black;width: 28%" class="cell_spacing"><?=$data->payername?></td>
    ...
    <tr>
        ...
        <td style="border: 1px solid black;" class="cell_spacing"><?=$data->bankname?$data->bankname:'无'?></td>
    ...
    <tr>
        <td style="border: 1px solid black;vertical-align: middle;" class="cell_spacing" colspan="2" height="160px" rowspan="2">
            <img src="<?=$stamper_png?>" style="width: 100%">
        </td>
    ...
    <tr>
        <td style="border: 1px solid black;text-align: left;font-weight: bold;height: 26px;" class="cell_spacing" colspan="4">重要提示:此回单为网上银行打印,请勿重复记账。</td>
    </tr>

    <tr>
        <td style="text-align: right;padding-right: 45px;padding-top: 10px;" colspan="6">记帐日期: <?=$data->receiptdate?></td>
    </tr>
</table>
